...
import 'package:task_manager_app/ui/controllers/signup_provider.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signUp() async {
    final bool isSuccess = await signupProvider.signUp(
    ...
    if (isSuccess) {
      showSnackBarMessage(context, 'Register successfull,please signin!');
    } else {
      showSnackBarMessage(context, signupProvider.errorMessage!);
    }
  }
